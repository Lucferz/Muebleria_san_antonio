...
<div class="sidebar">
   ...
   <a href="inicio.php" id="inicio"><ion-icon name="home-outline"></ion-icon><span> Inicio</span></a>
   ...
   <a href="cobranzasview.php"><ion-icon name="cash-outline"></ion-icon><span> Cobro</span></a> 
   <nav>
         <div class="informes">
